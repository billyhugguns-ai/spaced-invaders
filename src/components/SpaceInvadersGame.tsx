...
export function SpaceInvadersGame() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl bg-neutral-950 border-x border-neutral-800 px-4 py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
        {/* Coin Slot & Credits */}
